...
@EventDriven
@SupportsBatching
public class PutHazlecastMap extends AbstractProcessor {
    ...
    private PutFlowFile processFlowFile(final ProcessSession session, final ProcessContext context, final FlowFile flowFile){
        ...
        putFlowFile.setFlowFile(flowFile);
        ...
        try {
            ...
            clientService.put(MAP_NAME.getName(), jsonDataIn.get().get("key"), jsonDataIn.get().get("value"));
